...
INSERT INTO tb_users (full_name, email, birth_date, phone_number, cpf, address, number, district, zip_code, city, state, country, created_at, updated_at, status, password) VALUES ('Usuário Demo', 'demo@erp.com', '1990-01-01', '(11)99999-0000', '000.000.000-00', 'Rua Demo', '1', 'Centro', '00000000', 'Demo City', 'SP', 'Brasil', NOW(), NOW(), 'ACTIVE', '$2a$10$5l26kCKUQgLt7sMN1bVR2ODt67K/YaHcOvxvO9fUsF72rcweAsPt.');
